...
//Xây d?ng l?p Phân s? g?m các thu?c tính: t? s? và m?u s?, các phýõng th?c nh?p, xu?t, ...
//
//Vi?t hàm main:
//
//* Nh?p vào 2 phân s?, phân s? th? nh?t dùng hàm t?o có ð?i, phân s? th? 2 dùng phýõng th?c nh?p
//* C?ng, tr?, nhân, chia 2 phân s?
//* So sánh 2 phân s? v?a nh?p
//* Cho bi?t phân s? t?ng có l?n hõn 1 hay không
//* Ngh?ch ð?o 1 phân s?
//* Ki?m tra phân s? có ph?i là t? l?n hõn m?u hay không
//* Rút g?n phân s? hi?u v?a tính
//* C?ng phân s? t?ng v?i 1 ðõn v?
