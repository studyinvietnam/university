...
enum opt_code
{
  ...
  OPT_mnoreturn_no_callee_saved_registers = 2306,/* -mnoreturn-no-callee-saved-registers */
  ...
  OPT_mstack_protector_guard_offset_ = 2361, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2362,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2363, /* -mstack-protector-guard-symbol= */
