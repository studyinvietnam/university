...
SET CC=%~dp0bin/i686-w64-mingw32-gcc.exe
SET CXX=%~dp0bin/i686-w64-mingw32-g++.exe
SET FC=%~dp0bin/i686-w64-mingw32-gfortran.exe
SET F77=%~dp0bin/i686-w64-mingw32-gfortran.exe
SET LD=%~dp0bin/ld.exe
SET AR=%~dp0bin/i686-w64-mingw32-gcc-ar.exe
SET RANLIB=%~dp0bin/i686-w64-mingw32-gcc-ranlib.exe
SET WINDRES=%~dp0bin/windres.exe
SET RC=%~dp0bin/windres.exe
SET NM=%~dp0bin/i686-w64-mingw32-gcc-nm.exe
